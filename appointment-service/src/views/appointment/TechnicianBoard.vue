  ...
  <div class="technician_board_wrap clearfix">
    <div class="fl left_wrap">
      ...
      <div class="swiper-container5 "
           id='swiper-container5_id'>
        <div class="swiper-container"
             :style="{height:leftMaxHeight+'px'}">
          <div class="swiper-wrapper">
            <div class="swiper-slide tec_wrap">
              <template v-if='tecData.length'>
...
export default {
  ...
  methods: {
    ...
    cellClick (it, index) {
      let date = this.theader[index].date + ' ' + it.date + ':00'
      ...
      infoApi.technician_employees(obj).then(({ totalCount, technicians }) => {
        ...
        setTimeout(() => {
          ...
          new Swiper('.swiper-container5>.swiper-container', {
            ...
            freeMode: true,
            scrollbar: {
              el: '.swiper-container5  .swiper-scrollbar'
            },
            mousewheel: true
          })
          this.leftMaxHeight = document.documentElement.clientHeight - document.getElementById('swiper-container5_id').offsetTop - 80
        }, 5)
      })
    },
    getTheader (type) {
    ...
    initSwiper () {
      ...
      new Swiper('.swiper-container6>.swiper-container', {
        ...
        scrollbar: {
          el: '.swiper-container6 .swiper-scrollbar'
        },
        mousewheel: true
      })
